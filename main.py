...
args = dotdict({
    ...
    'numEps': 150,        #Originally 100    # Number of complete self-play games to simulate during a new iteration.
    ...
    'numMCTSSims': 30,          #Originally 25 # Number of games moves for MCTS to simulate.
