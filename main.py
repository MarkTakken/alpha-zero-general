...
args = dotdict({
    ...
    'load_model': True,
    'load_folder_file': ('./trained_models/9x9go','checkpoint_2.pth.tar'), #Originally /dev/models/8x100x50 , best.pth.tar
    'load_folder_file_examples': ('./trained_models/9x9go','checkpoint_1.pth.tar.examples'), #added
